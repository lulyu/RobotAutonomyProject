function [imu_position_all, imu_velocity_all, imu_orientation_all] = IMUCompute_step(IMUindices, imu_timestamps, body_accel, body_angvel, G, bias_accel, bias_angvel)
